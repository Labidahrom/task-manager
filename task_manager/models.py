...
class StatusFilter(django_filters.FilterSet):
    ...
    def __init__(self, *args, **kwargs):
        ...
        name_data = Status.objects.values_list('name', flat=True).distinct()
        name_data = [(choice, choice) for choice in name_data]
        self.filters['name'].field.choices = name_data
        id_data = Status.objects.values_list('id', flat=True).distinct()
        id_data = [(choice, choice) for choice in id_data]
        self.filters['id'].field.choices = id_data
...
class TaskFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = Task
        fields = ['status', 'author', 'assigned_to']